...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Destination 1", for: indexPath) as! StopTableViewCell
        if (self.stateController!.trans) {
            cell.hiddenl.isHidden = false
        }
        return cell
    }
